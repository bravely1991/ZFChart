...
/** 存储每个描述文字的数组 */
@property (nonatomic, strong) NSMutableArray * describePointArray;

@property (nonatomic, strong) NSMutableArray * extendPointArray;
@property (nonatomic, strong) NSMutableArray * extendColorArray;
